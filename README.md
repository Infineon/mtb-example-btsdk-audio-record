...
For CYW920721M2EVK-02, PDM, on-board DMIC, can be used as audio input by setting ENABLE_PDM=1 flag.
When enabled, the base board SW4 must be switched to DMIC. The C-compiler flag AUDIO_RECORD_ON_PDM_INPUT will
