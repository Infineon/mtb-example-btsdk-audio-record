...
## Overview
This application demonstrates the use of the on-board microphone on a WICED board to record audio.

## Instructions
To demonstrate the app, follow these steps:

1. Build and download the application to the WICED board.
2. Press and hold the CUSTOM button to record audio via the on-board MIC.
